...
static const char *fonts[]          = { "Inconsolata:size=10", "fontawesome:size=12" };
...
#define FORCE_VSPLIT 1  /* nrowgrid layout: force two clients to al    ways split vertically */
...
static const char *dmenucmd[] = { "dmenu_run_history.sh", NULL }; //{ "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_i,      incnmaster,     {.i = +1 } }, // increase master count
...
// gaps
    ...
    { MODKEY|ControlMask,           XK_p,      incrihgaps,     {.i = +1 } },
    { MODKEY|ControlMask|ShiftMask, XK_p,      incrihgaps,     {.i = -1 } },
    ...
    { MODKEY|ControlMask|ShiftMask, XK_k,      incrohgaps,     {.i = -1 } },
    { MODKEY|ControlMask,           XK_l,      incrovgaps,     {.i = +1 } },
    { MODKEY|ControlMask|ShiftMask, XK_l,      incrovgaps,     {.i = -1 } },
